...
const dummyListings = [
    ...
    },
    {
        ...
        year: 2017,
        price: 32000,
        description: "Selling my 2017 F150 Lariat 5.0. Reason for selling is I have purchased a new vehicle. Truck has -6 inch Zone Lift Kit -35x12.50 R20 Hercules Terra Trac Tires 20x10 -18 Fuel coupler rims Muffler delete",
        photos: ["/images/marketplace/truck1.jpg","/images/marketplace/truck2.jpg","/images/marketplace/truck3.jpg","/images/marketplace/truck4.jpg"],
        rate: 5.29,
        termMonths: 84,
    },
    {
    ...
    },
    {
        ...
        year: 2019,
        price: 9500,
        description: "Looking to sell my 2019 Arctic Cat M8000. Sled is in mint shape with under 3000 kms. Reason for selling is little use for it.",
        photos: ["/images/marketplace/skidoo1.jpg","/images/marketplace/skidoo2.jpg","/images/marketplace/skidoo3.jpg","/images/marketplace/skidoo4.jpg"],
        rate: 5.29,
        termMonths: 60,
    },
      ...
      <div className="marketplace-content">
        <aside className="marketplace-filters">
            ...
            <div className="filter-group">
                <h4>Seller Type</h4>
                <label><input type="checkbox"/>Dealership</label>
                <label><input type="checkbox"/>Private Seller</label>
            </div>
            <div className="filter-group">
                <h4>Category</h4>
                <label><input type="checkbox"/>Powersports</label>
                <label><input type="checkbox"/>Marine</label>
         ...
         <div className="filter-group">
            ...
            <label><input type="radio" name="price"/>$10,000 - $25,000</label>
            <label><input type="radio" name="price"/>$25,000 - 50,000</label>
            <label><input type="radio" name="price"/>Over $50,000</label>
         </div>
